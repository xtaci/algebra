...
7. 得到 $s_1,s_2$ **_关于系数的表达式后_**，对 $s_1,s_2$ 开三次方根，得到形如 $x_1+\omega x_2 + \omega^2x_3 = \sqrt[3]{A}$，  $x_1+\omega^2 x_2 + \omega x_3 = \sqrt[3]{B}$ 的另两个三元一次线性无关等式，联立韦达定理的第一个 $x_1+x_2+x_3=-p$ 的表达式，构成三元一次方程组( $3 * 3$ 矩阵）。解三元一次线性方程组，得到 $x_1,x_2,x_3$ 。
